...
| 代码风格 | [docs/development/code-style.md](./development/code-style.md) | 代码规范 |
| Git 工作流 | [docs/development/git-workflow.md](./development/git-workflow.md) | 分支策略 |
| 项目架构 | [docs/architecture/overview.md](./architecture/overview.md) | 整体架构 |
...
| 详细开发指南 | [apps/server/docs/DEVELOPMENT_GUIDELINES.md](../apps/server/docs/DEVELOPMENT_GUIDELINES.md) |
...
echo "<!-- <你的名字> onboarded on $(date +%Y-%m-%d) -->" >> docs/ONBOARDING.md
