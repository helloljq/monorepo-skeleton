...
```
docs/
├── DOC_STANDARDS.md              # 本规范文件
├── DEVELOPMENT_GUIDELINES.md     # 开发规范（长期有效）
│
├── backlog/                      # 待办事项与评审记录
│   ├── README.md                 # backlog 索引
│   └── YYYY-MM-DD_<主题>.md      # 按日期+主题命名
│
├── features/                     # 功能开发文档（归档）
│   └── YYYY-MM-DD_<功能名>/      # 按日期+功能名创建目录
│       ├── task.md               # 任务描述
...
| 类型 | 格式 | 示例 |
|------|------|------|
| 规范类 | `UPPERCASE_NAME.md` | `DEVELOPMENT_GUIDELINES.md` |
| 待办/评审 | `YYYY-MM-DD_<主题>.md` | `2025-12-24_code-review.md` |
| 功能目录 | `YYYY-MM-DD_<功能名>/` | `2025-12-23_feat_init/` |
...
|------|------|------|
| `task.md` | 是 | 任务描述、需求来源 |
| `implementation_plan.md` | 是 | 技术方案、实现步骤 |
| `api.md` | 否 | API 接口设计 |
| `schema.md` | 否 | 数据库设计 |
| `test_plan.md` | 否 | 测试计划 |
...
现有 `2025-12-23_feat_init/` 目录保持不变，新功能文档统一放入 `features/` 子目录。
...
| 日期 | 主题 | 状态 | 链接 |
|------|------|------|------|
| 2025-12-24 | 代码评审 | 进行中 | [查看](./2025-12-24_code-review.md) |
```
