...
| 接口 | 方法 | 认证 | 说明 |
|------|------|------|------|
| `/api/v1/script/upload` | POST | X-Script-Token | 上传脚本数据 |
| `/api/v1/script/download/:key` | GET | X-Script-Token | 下载脚本数据 |
| `/api/v1/script/list` | GET | X-Script-Token | 列出所有脚本数据 |

### 公开配置接口

| 接口 | 方法 | 认证 | 说明 |
|------|------|------|------|
| `/api/v1/config/public/:namespace/:key` | GET | 无 | 获取公开配置 |
