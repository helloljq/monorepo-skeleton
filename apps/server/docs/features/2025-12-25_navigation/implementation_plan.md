...
| 方法 | 路径 | 说明 |
|------|------|------|
| GET | `/api/v1/navigation/public` | 获取公共导航（带缓存） |

### 3.2 用户接口（需登录）

| 方法 | 路径 | 说明 |
|------|------|------|
| GET | `/api/v1/navigation/merged` | 获取合并导航（公共+个人） |
| POST | `/api/v1/navigation/my/groups` | 创建个人分组 |
| GET | `/api/v1/navigation/my/groups` | 获取个人分组列表 |
| PATCH | `/api/v1/navigation/my/groups/:id` | 更新个人分组 |
| DELETE | `/api/v1/navigation/my/groups/:id` | 删除个人分组 |
| PATCH | `/api/v1/navigation/my/groups/reorder` | 批量调整分组排序 |
| POST | `/api/v1/navigation/my/items` | 创建个人导航项 |
| GET | `/api/v1/navigation/my/items` | 获取个人导航项列表 |
| PATCH | `/api/v1/navigation/my/items/:id` | 更新个人导航项 |
| DELETE | `/api/v1/navigation/my/items/:id` | 删除个人导航项 |
| PATCH | `/api/v1/navigation/my/items/reorder` | 批量调整导航项排序 |

### 3.3 管理员接口

| 方法 | 路径 | 权限 |
|------|------|------|
| POST | `/api/v1/admin/navigation/groups` | navigation:group:create |
| GET | `/api/v1/admin/navigation/groups` | navigation:group:read |
| GET | `/api/v1/admin/navigation/groups/:id` | navigation:group:read |
| PATCH | `/api/v1/admin/navigation/groups/:id` | navigation:group:update |
| DELETE | `/api/v1/admin/navigation/groups/:id` | navigation:group:delete |
| PATCH | `/api/v1/admin/navigation/groups/reorder` | navigation:group:update |
| POST | `/api/v1/admin/navigation/items` | navigation:item:create |
| GET | `/api/v1/admin/navigation/items` | navigation:item:read |
| GET | `/api/v1/admin/navigation/items/:id` | navigation:item:read |
| PATCH | `/api/v1/admin/navigation/items/:id` | navigation:item:update |
| DELETE | `/api/v1/admin/navigation/items/:id` | navigation:item:delete |
| PATCH | `/api/v1/admin/navigation/items/reorder` | navigation:item:update |
| GET | `/api/v1/admin/navigation/full` | navigation:group:read |
