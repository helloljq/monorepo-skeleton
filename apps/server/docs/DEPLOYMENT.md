...
| 文档 | 说明 |
|------|------|
| [快速参考指南](/docs/deployment/QUICKSTART.md) | 本地开发、Staging/Prod 部署速查 |
| [完整部署手册](/docs/deployment/DEPLOYMENT_GUIDE.md) | 从零开始的详细部署步骤 |
| [CI/CD 流程](/docs/deployment/ci-cd.md) | 自动化部署流程 |
| [环境说明](/docs/deployment/environments.md) | 各环境配置差异 |
...
- [完整部署手册](/docs/deployment/DEPLOYMENT_GUIDE.md)
- [Staging 故障排查](/docs/deployment/STAGING_TROUBLESHOOTING.md)
