            ...
            <main className="flex-1 pt-16">
                ...
                <section className="py-16 bg-white">
                    <div className="max-w-3xl mx-auto px-4">
                        <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">品牌故事</h2>
                        <div className="prose prose-lg mx-auto text-gray-600">
                            <p className="mb-6">
                                {{TITLE}}成立于杭州，诞生于对“纯净营养”的执着追求。在这个充斥着过度加工和添加剂的时代，我们经常问自己：**能不能做一款自己和家人都敢放心吃的营养品？**
                            </p>
                            <p className="mb-6">
                ...
                <section className="py-16 bg-gray-50">
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="text-center mb-12">
                            <h2 className="text-3xl font-bold text-gray-900">我们的核心价值观</h2>
                        </div>
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
                            <div className="bg-white p-8 rounded-2xl shadow-sm">
                                ...
                                <p className="text-gray-600">一切产品研发都源于用户的真实需求，做即食懂你的营养伴侣。</p>
                            </div>
                            <div className="bg-white p-8 rounded-2xl shadow-sm">
                                ...
                                <p className="text-gray-600">坚持“0添加”理念，严格把控原料与生产，只提供安全可靠的营养。</p>
                            </div>
                            <div className="bg-white p-8 rounded-2xl shadow-sm">
                                ...
                                <p className="text-gray-600">依托科学配方与先进工艺，让每一份营养都能被身体高效吸收。</p>
                            </div>
                        </div>
                    </div>
                </section>
